...
class WaspWIFI
{
  ...
  private:	
    ...
    //! Specifies the question/command/message that is sent to the WiFi module.
    char question[128];
    ...
    */
    bool contains(char* text, char* word);

    //! Reads data over the UART.
    /*!
      \param uint8_t length : Specifies the minimum length it is expected 
      to read.
      \return '1' on success, '0' otherwise.
    */
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \return '1' on success, '0' otherwise.
      */
    uint8_t setTCPclient(ipAddr ip_remote, uint16_t port_remote, 
			 uint16_t port_local);
    ...
    /*!
      ...
      \return '1' on success, '0' otherwise.
      */
    uint8_t setUDPclient(ipAddr ip_remote, uint16_t port_remote, 
			 uint16_t port_local);
    ...
    */
    ...
    /*!
      ...
      \return '1' on success, '0' otherwise.
    */
    uint8_t getFile(char* file, char* local_folder, char* remote_folder);
    ...
    */
    ...
    /*!
      ...
      \param uint16_t length : specifies the lenght of the data to send.
      \return void
      */
    void send(uint8_t* data, uint16_t lenght);
    ...
    /*!
      ...
      \return '1' on success, '0' otherwise.
      */
    uint8_t sendAutoBroadcast(ipAddr ip_network, uint16_t port_remote,
    ...
    */ 
    ...
    //! Wakes the device and switches to command mode.
    /*!
      \param void
      \return void
    */ 
