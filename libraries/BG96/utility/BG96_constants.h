...
const char BG96_GPS_07[]	PROGMEM = "AT+QGPSCFG=\"beidounmeatype\",%u\r";						//6
const char BG96_GPS_08[]	PROGMEM = "AT+QGPSCFG=\"gsvextnmeatype\",%u\r";						//6
const char BG96_GPS_09[]	PROGMEM = "$GPGLL";								//7
const char BG96_GPS_10[]	PROGMEM = "$GPVTG";								//8
const char BG96_GPS_11[]	PROGMEM = "$GPGSA";								//9
const char BG96_GPS_12[]	PROGMEM = "$GPGGA";								//10
const char BG96_GPS_13[]	PROGMEM = "$GPRMC";								//11
const char BG96_GPS_14[]	PROGMEM = "$GPGSV";								//12
const char BG96_GPS_15[]	PROGMEM = "AT+QGPSLOC?\r";							//13
const char BG96_GPS_16[]	PROGMEM = "AT+QGPSLOC=%u\r";							//14
const char BG96_GPS_17[]	PROGMEM = "AT+QGPSGNMEA=\"%s\"\r";							//15
const char BG96_GPS_18[]	PROGMEM = "GGA";					//16
const char BG96_GPS_19[]	PROGMEM = "RMC";	//17
const char BG96_GPS_20[]	PROGMEM = "GSV";								//18
const char BG96_GPS_21[]	PROGMEM = "GSA";	//19
const char BG96_GPS_22[]	PROGMEM = "VTG";						//20
const char BG96_GPS_23[]	PROGMEM = "GNS";	//21
