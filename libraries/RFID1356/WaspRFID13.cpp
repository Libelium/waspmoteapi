...
#include "WaspRFID13.h"
 ...
 //***********************************************************
    ...
    */ uint8_t WaspRFID::readWithAuth(uint8_t *UID , uint8_t *keyAccess , uint8_t *data , uint8_t address)
	{
		_UID[0] = UID[0]; 	_UID[2] = UID[2];
		_UID[1] = UID[1];	_UID[3] = UID[3];
    ...
    */ uint8_t WaspRFID::writeWithAuth(uint8_t *UID , uint8_t *keyAccess , uint8_t *data , uint8_t address)
	{
		_UID[0] = UID[0]; 	_UID[2] = UID[2];
		_UID[1] = UID[1];	_UID[3] = UID[3];
    ...
    */	uint8_t  WaspRFID::writeAndCheck(uint8_t *data, uint8_t address)
    ...
    /*! 	
     ...
     \param  uint8_t _data : data to write.
     \param  uint8_t address: the address where write  _data. 
    */	uint8_t WaspRFID::writeAndCheckWithAuth(uint8_t *UID, uint8_t *keyAccess , uint8_t *data , uint8_t address)
	{
		_UID[0] = UID[0]; 	_UID[2] = UID[2];
		_UID[1] = UID[1];	_UID[3] = UID[3];
