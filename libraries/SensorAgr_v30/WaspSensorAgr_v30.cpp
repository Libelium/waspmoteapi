 ...
 * 			-1 if error
 */
uint32_t WaspSensorAgr_v30::getLuxes()
{
 ...
 * 			-1 if error
 */
uint32_t WaspSensorAgr_v30::getLuxes(bool gain)
{
...
//!	Returns:  uint32_t: luxes value read or -1 if error
//!*********************************************************************
uint32_t WaspSensorAgr_v30::getLuxes(bool gain, uint8_t res){
	uint8_t error;
	TSL.ON();
	//Switch ON I2C
	digitalWrite(I2C_PIN_OE, HIGH);
