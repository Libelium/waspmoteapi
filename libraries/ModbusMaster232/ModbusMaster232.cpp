/*
  ModbusMaster232.cpp - Waspmote library for communicating with Modbus slaves
...
@ingroup setup
*/
ModbusMaster232::ModbusMaster232(uint8_t u8SerialPort, uint8_t u8MBSlave)
{
	W232.ON(u8SerialPort);
	_u8MBSlave = u8MBSlave;
}
...
@ingroup setup
*/
void ModbusMaster232::begin(unsigned long BaudRate , uint8_t socket)
{
